...
op chal_seen_init : (hash_input * hash_input) list = [].

module G4_Hash(A : PCR_REAL_ADV) = {
  var bb : election_bb
  ...
  var hash_collision_flag : bool
  var chal_seen : (hash_input * hash_output) list
...
axiom hop_G3_G4 (A <: PCR_REAL_ADV {-G3_MixDDec, -G4_Hash}) &m lambda nT t nV nA nC :
