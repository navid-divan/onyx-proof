...
module Hybrid_H1(A : PCR_REAL_ADV) = {
  var bb : election_bb
...
lemma hybrid_H0_H1_bound (A <: PCR_REAL_ADV) &m lambda nT t nV nA nC :
  `| Pr[Hybrid_H0(A).main(lambda, nT, t, nV, nA, nC) @ &m : res]
   - Pr[Hybrid_H1(A).main(lambda, nT, t, nV, nA, nC) @ &m : res] |
  <= (q_d)%r * advantage_NIZK_rd lambda_sec.
proof.
admit.
qed.
