...
EXPECTED_FILES=(
  ...
  "Onyx/Onyx.ec"
  "Hybrids/G1_UT.ec"
  "Hybrids/G2_MixShuf.ec"
  "Hybrids/G3_MixDDec.ec"
  "Hybrids/G4_Hash.ec"
  "Hybrids/G5_NIZK_ZK.ec"
  "Hybrids/G6_dFHE_CPA.ec"
  "Hybrids/G7_DiscRand.ec"
  "Hybrids/G8_Ideal.ec"
  "Reductions/Red_UT.ec"
  "Reductions/Red_MixShuf.ec"
  "Reductions/Red_MixDDec.ec"
  "Reductions/Red_Hash.ec"
  "Reductions/Red_NIZK_ZK.ec"
  "Reductions/Red_dFHE_CPA.ec"
...
summary() {
  ...
  echo "     Hybrids/G?_*.ec      : Nine hybrid games (G_0..G_8) matching the paper."
